...
class ClimatePanelHubDevice extends HubDevice
{
	...
	async onInit()
	{
		...
		this.log('ClimatePanelHubDevice has been initialized');
	}
	...
	async onAdded()
	{
		this.log('ClimatePanelHubDevice has been added');
	}
	...
	{
		this.log('ClimatePanelHubDevice was renamed');
	}
...
module.exports = ClimatePanelHubDevice;

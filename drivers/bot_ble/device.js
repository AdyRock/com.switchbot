    ...
    async _operateBotLoop(bytes)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                this.log("Getting notify characteristic");
                bleNotifyCharacteristic = await bleService.getCharacteristic('cba20003224d11e69fb80002a5d5c51b');
            ...
            finally
            {
                ...
                {
                    await bleNotifyCharacteristic.unsubscribeFromNotifications();
                }
